...
3. **Pick a persona.** Which audience are you writing for? A first-time bride researching dress fabrics reads differently than a repeat pet-supplies shopper comparing subscriptions.
